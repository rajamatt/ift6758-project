...
class NHLStats:
    ...
    def plot_shot_distance_probability(self,start_season:int,end_season:int=0,bin_width:float=1):
        ...
        if end_season==0 or start_season==end_season:
            plt.suptitle(f"Shot Distance Probability ({start_season})",fontsize='medium')
        else:
            plt.suptitle(f"Shot Distance Probability ({start_season}-{end_season})",fontsize='medium')
